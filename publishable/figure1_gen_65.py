...
from svgkit_71 import FIGURE1, w_of as _w_of
...
def w_of(s, fs, spacing=0.0):
    """This figure's frozen width metric — svgkit_71.FIGURE1, unchanged.

    The numbers (0.52 default, the «» in the narrow set) are CALLER-OWNED and
    baked into the committed SVG; see svgkit_71's docstring before touching
    them. The shim keeps the positional third argument every call site here
    already uses, e.g. w_of(label, FS_LAB, 1.5).
    """
    return _w_of(s, fs, spacing=spacing, **FIGURE1)
