...
from svgkit_71 import FIGURE2, esc, w_of as _w_of
...
def w_of(s, fs, spacing=0.0):
    """This figure's frozen width metric — svgkit_71.FIGURE2, unchanged.

    The 0.50 default here and figure1's 0.52 disagree ON PURPOSE: both are
    baked into already-published SVGs. See svgkit_71's docstring. The shim
    keeps the positional third argument the title measurements use, e.g.
    w_of(c["name"], FS_TITLE, 1.5).
    """
    return _w_of(s, fs, spacing=spacing, **FIGURE2)
