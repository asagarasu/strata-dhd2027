...
Round 1 (the fun trio):
  gt_en_tiaotiao.txt   — 迢迢牽牛星 (10 lines zh) → English
  gt_en_xibei.txt      — 西北有高樓 (16 lines zh) → English
  gt_zh_sonnet18.txt   — Sonnet 18 (1609 text, 14 lines en) → Chinese
Prediction on record (#59): strong SURVIVAL on stated traits; UNHEARD on the
ghosts — "the machine translates everything except what was never written down."
